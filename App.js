...
export default class App extends React.Component {
  ...
  scratchItem = (itemNumber) =>{
    if(this.state.chancesLeft===0){
      ...
      this.setState({chancesLeft:this.state.chancesLeft-1})
  ...
  showAllItem=()=>{
    ...
    resetGame=()=>{
     this.setState({randomNumber:this.generateRandomNumber(),chancesLeft:"5"},()=>{
  ...
  return (
    <View style={styles.container}>
      ...
      <Text>Chances Left:{this.state.chancesLeft}</Text>
